...
public class NewsApp extends App{ //superclass are specialised classes
    ...
    /*public NewsApp(String appName, String appDescription, int noOfDownloads, /*String typeOfApp,*/ /*double appCost, boolean freeApp, String developerName, String category, int minAgeLimit) {//private Administrator administrator;
    ...
    public NewsApp(String typeOfApp, String appName, String appDescription, int noOfDownloads, /*String typeOfApp,*/ double appCost, 
            boolean freeApp, String developerName, String appLogoAddress, String category, int minAgeLimit/*, Administrator aAdministrator*/) {

...
public class editApp extends JFrame {
    ...
    private void initializeGui() {
        ...
        pane.setLayout(new GridBagLayout());
            ...
            // Declear JLabel
            JLabel typeApp, editMenu, appNameTxt, appDiscript, numDown, appFree, appCost, devName, category, minAge;
            
            // Header
            editMenu=new JLabel("EDIT APPLICATION");  
            editMenu.setBounds(250,50, 300,100);  
            editMenu.setFont(new Font("Arial", Font.PLAIN, 25));
            pane.add(editMenu);
            ...
            appNameTxt.setBounds(50,135, 300,100);  
 ...
 //comment for change in document
    public void dispose() {
        // TODO: Save settings
        //super.dispose();
        System.exit(0);
